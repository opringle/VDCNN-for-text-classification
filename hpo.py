...
parser.add_argument('role_arn', type=str, help='arn of sagemaker execution role')
...
parser.add_argument('--data-dir', type=str, default='atb_model_39/strat_split/data', help='path to train/test pickle files')
...
if __name__ == '__main__':
    ...
    hyperparameters = {'epochs': 30, 'batch_size': 128, 'max_train_records': None, 'gpus': 1,
