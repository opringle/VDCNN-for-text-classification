...
# hmmm
python vdcnn.py --gpus=0 --data=../../finn-dl/MODEL/atb_model_41/strat_split/data/ --sequence-length=64 --batch-size=128 --lr=0.01 --blocks='2,2,2,2' --channels='64,128,256,512' --fc-size=10
