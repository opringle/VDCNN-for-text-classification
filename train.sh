...
#--checkpoint-freq=1 --load-prefix=./yahoo_model/checkpoint --load-epoch=3 \
...
python vdcnn.py --gpus=0 --data=./data/yahoo_answers/ --output-dir=yahoo_model --checkpoint-freq=1 \
--num-epochs=256 --batch-size=512 --sequence-length=107 --char-embed=16 \
--lr=0.00006 \
--l2=0.0 --dropout=0.0 --smooth-alpha=0.001 \
--blocks=4,7,3