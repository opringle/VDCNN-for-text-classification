...
parser.add_argument('--lr', type=float, default=0.059801136409934885,
                    help='learning rate for chosen optimizer')
parser.add_argument('--momentum', type=float, default=0.9312060606446801,
                    help='momentum for optimizer')
parser.add_argument('--lr-update-factor', type=float, default=0.999,
...
parser.add_argument('--dropout', type=float, default=0.021612639141339468,
                    help='dropout regularization probability for penultimate layer')
parser.add_argument('--smooth-alpha', type=float, default=0.00402,
                    help='label smoothing coefficient')

# Architecture
parser.add_argument('--char-embed', type=int, default=2,
                    help='character vector embedding size')
parser.add_argument('--temp-conv-filters', type=int, default=15,
                    help='character vector embedding size')
parser.add_argument('--block1_blocks', type=int, default=4,
                    help='number of blocks in section')
parser.add_argument('--block2_blocks', type=int, default=3,
                    help='number of blocks in section')
parser.add_argument('--block3_blocks', type=int, default=2,
                    help='number of blocks in section')
...
def build_symbol_inception(iterator, preprocessor, hyperparameters):
    """
